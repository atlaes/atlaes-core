...
// Figma 1858-711 — the final public-sector questionnaire. Mirrors the
// calculator's PUBLIC_ELIGIBILITY_QUESTIONS verbatim; any 'yes' blocks the
// refund (flows/public-sector.ts checkEligibility('public_final_questions')).
const QUESTIONS: { field: QuestionField; question: string; helper?: string }[] =
  [
    {
...
export const PublicFinalQuestions: React.FC = () => {
  ...
  const [answers, setAnswers] = useState<Record<QuestionField, YesNo>>({
    publicWorkedPublicAfter: data.publicWorkedPublicAfter || '',
    publicOtherInstitution: data.publicOtherInstitution || '',
    publicPriorRefund: data.publicPriorRefund || '',
    publicCivilServant: data.publicCivilServant || '',
  });
    ...
    <div className="mx-auto max-w-[640px]">
      <div className="mb-9 text-center">
        ...
        <p className="mx-auto mt-4 max-w-[560px] text-[16px] leading-6 text-[#4B5563]">
          Please answer these final questions so we can complete your refund
          check.
        </p>
      </div>
